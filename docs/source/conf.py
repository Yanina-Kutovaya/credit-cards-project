...
# credit_cards_fraud_detection documentation build
...
from credit_cards_fraud_detection import __version__ as release

# -- Project information -----------------------------------------------------

project = "credit_cards_fraud_detection"
author = "Kedro"
...
htmlhelp_basename = "credit_cards_fraud_detectiondoc"
...
latex_documents = [
    (
        master_doc,
        "credit_cards_fraud_detection.tex",
        "credit_cards_fraud_detection Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "credit_cards_fraud_detection",
        "Project credit_cards_fraud_detection codebase.",
        "Data-Science",
    )
]
